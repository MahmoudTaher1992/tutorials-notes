...
ROOT_DIR="Terminal-Knowledge-Study"
...
# ==============================================================================
PART_DIR="001-CLI-and-Shell-Fundamentals"
mkdir -p "$PART_DIR"

# Section A
FILE_PATH="$PART_DIR/001-Introduction-to-the-Terminal.md"
cat <<EOF > "$FILE_PATH"
...
# Section B
FILE_PATH="$PART_DIR/002-Filesystem-Navigation-and-Management.md"
cat <<EOF > "$FILE_PATH"
...
# Section C
FILE_PATH="$PART_DIR/003-Input-Output-and-Pipelines.md"
cat <<EOF > "$FILE_PATH"
...
# ==============================================================================
PART_DIR="002-Scripting-and-Automation"
mkdir -p "$PART_DIR"

# Section A
FILE_PATH="$PART_DIR/001-Bash-Scripting.md"
cat <<EOF > "$FILE_PATH"
# Bash Scripting
...
# Section B
FILE_PATH="$PART_DIR/002-PowerShell-Scripting.md"
cat <<EOF > "$FILE_PATH"
...
# ==============================================================================
PART_DIR="003-Text-Editors"
mkdir -p "$PART_DIR"

# Section A
FILE_PATH="$PART_DIR/001-Vim-Neovim.md"
cat <<EOF > "$FILE_PATH"
# Vim / Neovim
...
# Section B
FILE_PATH="$PART_DIR/002-Nano.md"
cat <<EOF > "$FILE_PATH"
# Nano
...
# Section C
FILE_PATH="$PART_DIR/003-Emacs.md"
cat <<EOF > "$FILE_PATH"
# Emacs
...
# ==============================================================================
PART_DIR="004-System-Monitoring-and-Management"
mkdir -p "$PART_DIR"

# Section A
FILE_PATH="$PART_DIR/001-Process-Monitoring.md"
cat <<EOF > "$FILE_PATH"
# Process Monitoring
...
# Section B
FILE_PATH="$PART_DIR/002-Performance-Monitoring.md"
cat <<EOF > "$FILE_PATH"
...
# ==============================================================================
PART_DIR="005-Networking-and-Text-Manipulation"
mkdir -p "$PART_DIR"

# Section A
FILE_PATH="$PART_DIR/001-Networking-Tools.md"
cat <<EOF > "$FILE_PATH"
# Networking Tools
...
# Section B
FILE_PATH="$PART_DIR/002-Text-Manipulation.md"
cat <<EOF > "$FILE_PATH"
# Text Manipulation
