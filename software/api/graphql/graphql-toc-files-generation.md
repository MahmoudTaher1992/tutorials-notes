Here is the bash script to generate the GraphQL study guide structure.

This script will create a root directory named `GraphQL-Comprehensive-Study`, generate the numbered subdirectories for each Part, and populate them with numbered Markdown files containing the relevant topics.

```bash
#!/bin/bash

# Define the root directory name
ROOT_DIR="GraphQL-Comprehensive-Study"

# Create the root directory
mkdir -p "$ROOT_DIR"
cd "$ROOT_DIR" || exit

echo "Creating directory structure for GraphQL Study Guide..."

# -----------------------------------------------------------------------------
# Part I: GraphQL Fundamentals & Core Concepts
# -----------------------------------------------------------------------------
DIR_NAME="001-GraphQL-Fundamentals-Core-Concepts"
mkdir -p "$DIR_NAME"

# File 1
cat <<EOF > "$DIR_NAME/001-Introduction-to-GraphQL.md"
...
# File 2
cat <<EOF > "$DIR_NAME/002-The-GraphQL-Ecosystem.md"
...
# -----------------------------------------------------------------------------
DIR_NAME="002-The-GraphQL-Schema"
mkdir -p "$DIR_NAME"

# File 1
cat <<EOF > "$DIR_NAME/001-Schema-Definition-Language.md"
...
# File 2
cat <<EOF > "$DIR_NAME/002-Type-System-Deep-Dive.md"
...
# File 3
cat <<EOF > "$DIR_NAME/003-Schema-Design-Best-Practices.md"
...
# -----------------------------------------------------------------------------
DIR_NAME="003-GraphQL-Queries"
mkdir -p "$DIR_NAME"

# File 1
cat <<EOF > "$DIR_NAME/001-Fundamentals-of-Queries.md"
...
# File 2
cat <<EOF > "$DIR_NAME/002-Advanced-Querying-Techniques.md"
...
# -----------------------------------------------------------------------------
DIR_NAME="004-GraphQL-Mutations"
mkdir -p "$DIR_NAME"

# File 1
cat <<EOF > "$DIR_NAME/001-Introduction-to-Mutations.md"
...
# File 2
cat <<EOF > "$DIR_NAME/002-Mutation-Design-Patterns.md"
...
# -----------------------------------------------------------------------------
DIR_NAME="005-GraphQL-Subscriptions"
mkdir -p "$DIR_NAME"

# File 1
cat <<EOF > "$DIR_NAME/001-Real-time-with-Subscriptions.md"
...
# File 2
cat <<EOF > "$DIR_NAME/002-Transporting-Subscriptions.md"
# Transporting Subscriptions
...
# -----------------------------------------------------------------------------
DIR_NAME="006-GraphQL-Server-Development"
mkdir -p "$DIR_NAME"

# File 1
cat <<EOF > "$DIR_NAME/001-The-Role-of-the-Server.md"
...
# File 2
cat <<EOF > "$DIR_NAME/002-Building-a-GraphQL-Server.md"
...
# File 3
cat <<EOF > "$DIR_NAME/003-Advanced-Server-Concepts.md"
...
# -----------------------------------------------------------------------------
DIR_NAME="007-GraphQL-Client-Development"
mkdir -p "$DIR_NAME"

# File 1
cat <<EOF > "$DIR_NAME/001-Consuming-a-GraphQL-API.md"
...
# File 2
cat <<EOF > "$DIR_NAME/002-Client-Libraries-and-Frameworks.md"
...
# File 3
cat <<EOF > "$DIR_NAME/003-Advanced-Client-Side-Features.md"
...
# -----------------------------------------------------------------------------
DIR_NAME="008-GraphQL-Ecosystem-Best-Practices"
mkdir -p "$DIR_NAME"

# File 1
cat <<EOF > "$DIR_NAME/001-Tooling-and-Developer-Experience.md"
...
# File 2
cat <<EOF > "$DIR_NAME/002-Production-Considerations.md"
...
# File 3
cat <<EOF > "$DIR_NAME/003-The-Future-of-GraphQL.md"
